...
- Progress includes Trend decision, Recovery debt, Weekly summary, Bodyweight, Transformation, Karate load, Recovery trend, Soreness map, Readiness mix, and charts for weight/waist/load/recovery/muscle heatmap.
